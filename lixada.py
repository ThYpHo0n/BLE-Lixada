...
if len(sys.argv) != 2:
    ...
    print 'Usage: sudo python lixada.py <bulb address>'
    print 'Example: sudo python lixada.py 5C:31:3E:F2:16:13'
    sys.exit(1)
bulb = sys.argv[1]
...
while True:
    ...
    gatt.sendline('char-write-cmd 0x0027 d0{0:02X}{1:02X}{2:02X}'.format(r, g, b))
